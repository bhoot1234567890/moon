      ...
      try {
        ...
        if (!video.src || video.src === window.location.href) {
          if (manifestData && manifestData.Videos && manifestData.Videos[mk]) {
            ...
            const fallback = `https://cdn.chaitanyamalhotra.com/assets/videos/video_mandal${mk}.mp4`;
            video.src = fallback;
...
gltfLoader.load(
  "https://cdn.chaitanyamalhotra.com/assets/models/golden-chariot-wheel-draco-ktx2.glb",
  (gltf) => {
